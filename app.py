...
def _inject_css():
    ...
    /* ── Nav bar: el bloque inmediatamente después del marcador es siempre horizontal ── */
    .nav-row-marker + div [data-testid="stHorizontalBlock"],
    .nav-row-marker ~ div [data-testid="stHorizontalBlock"]:first-of-type {
        flex-wrap: nowrap !important;
        gap: 2px !important;
    }
    .nav-row-marker + div [data-testid="stHorizontalBlock"] button,
    .nav-row-marker ~ div [data-testid="stHorizontalBlock"]:first-of-type button {
...
def _render_bottom_nav():
    """Barra de navegación horizontal — siempre en fila, nunca apilada."""
    page   = st.session_state.page
    active = "home" if page in _HOME_PAGES else page
    if page in ("budgets", "categories", "profile", "more"):
        active = "more"

    # Marcador para que el CSS identifique este bloque como el nav
    st.markdown('<div class="nav-row-marker"></div>', unsafe_allow_html=True)
...
def main():
    ...
    # Barra de navegación SIEMPRE al tope del contenido
    _render_bottom_nav()
