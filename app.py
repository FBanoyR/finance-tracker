...
def _inject_pwa_meta():
    """
    Inyecta meta tags para que la app sea instalable como PWA en móvil.
    El emoji 💰 se usa como ícono nativo — funciona en iOS y Android.
    """
    st.markdown(
        """
        <head>
        <!-- Nombre y color de la app al instalarla -->
        ...
        <!-- Ícono emoji como SVG (funciona en todos los navegadores modernos) -->
        <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>💰</text></svg>">
        <link rel="apple-touch-icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='20' fill='%23667eea'/><text x='50' y='72' font-size='65' text-anchor='middle'>💰</text></svg>">
        ...
        <link rel="manifest" href="data:application/json,{
            ...
            &quot;icons&quot;: [{
                &quot;src&quot;: &quot;data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><rect width='512' height='512' rx='80' fill='%23667eea'/><text x='256' y='380' font-size='380' text-anchor='middle'>💰</text></svg>&quot;,
                &quot;sizes&quot;: &quot;512x512&quot;,
                &quot;type&quot;: &quot;image/svg+xml&quot;,
...
def _inject_css():
    ...
    /* ── Ocultar toolbar de Streamlit (Fork, GitHub, menú) ── */
...
def _render_sidebar():
    ...
    with st.sidebar:
        ...
        # ── Opciones (expander) ───────────────────────────────────────────────
        opt_open = st.session_state.page in ("budgets", "categories", "profile")
        with st.expander("⚙️ Opciones", expanded=opt_open):
            for label, key in {
